"""Run Timeline repository contracts against the official SQLAlchemy adapter."""
...
@pytest.fixture
def repository(session: Session) -> TimelineRepository:
...
class TestSQLAlchemyTimelineRepository(TimelineRepositoryContract):
