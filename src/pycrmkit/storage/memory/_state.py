...
class _MemoryState:
    ...
    communication_intents: dict[CommunicationIntentId, CommunicationIntent] = field(
        default_factory=dict
    )
    delivery_attempts: dict[DeliveryAttemptId, DeliveryAttempt] = field(
        default_factory=dict
    )
    communication_records: dict[CommunicationRecordId, CommunicationRecord] = field(
        default_factory=dict
    )
