...
from pycrmkit.communication.entities import CommunicationIntent, CommunicationIntentId, CommunicationRecord, CommunicationRecordId, DeliveryAttempt, DeliveryAttemptId
